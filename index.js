...
* (Scriptnya Nfq cuy).
*/
const BotName = '👾Rizkybot��'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/ff.rizkygans1'; // Nama Instagramlu cok
const whatsapplu = 'Wa.me/6288292030664'; // Nomor whatsapplu cok
const kapanbotaktif = 'Tergantung jaringan'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/G3yYhho2lz4D3UiruLHp1M'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://www.youtube.com/channel/UChgdeBl3JTdHuOoppdyaNcQ'; // OFFICIAL YT LU
const grupch3 = 'https://chat.whatsapp.com/G3yYhho2lz4D3UiruLHp1M'; // OFFICIAL GRUP LU 3
//
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] TINGGAL SCAN :@ff.rizkygans1`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by Ghalyh Squad`))
...
conn.sendMessage(id, 'Owner Rizkybot : wa.me/6288292030664' ,MessageType.text);
}
else if (text == 'bot'){
